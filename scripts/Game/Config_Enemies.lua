...
Config.ENEMY_DEF_HP_RATIO = 0.10     -- DEF 占 HP 缩放的 10%（HP 大幅拉升后降低 DEF 占比）

-- 怪物随关卡成长的防御属性（对抗英雄各乘区膨胀）
-- 分段线性插值，格式: { stageFrom, stageTo, valueFrom, valueTo }
Config.ENEMY_SCALING = {
    -- 暴击伤害减免: 降低英雄暴击乘区（0 = 不减免, 0.40 = 暴击伤害打6折）
    critDmgReduce = {
        {    1,   300,   0.00,  0.00 },   -- 前期不减免
        {  300,  1000,   0.00,  0.10 },   -- 中期缓慢增长
        { 1000,  2500,   0.10,  0.25 },   -- 中后期显著
        { 2500,  4500,   0.25,  0.35 },
        { 4500,  6000,   0.35,  0.40 },   -- 终局：暴击伤害打6折
    },
    -- 伤害加成减免: 降低英雄 dmgBonus 乘区（0 = 不减免, 0.35 = 伤害加成打65折）
    dmgBonusReduce = {
        {    1,   500,   0.00,  0.00 },
        {  500,  1500,   0.00,  0.10 },
        { 1500,  3000,   0.10,  0.20 },
        { 3000,  5000,   0.20,  0.30 },
        { 5000,  6000,   0.30,  0.35 },   -- 终局：伤害加成打65折
    },
    ...
    elemDmgReduce = {
        ...
        { 1500,  3000,   0.08,  0.15 },
        { 3000,  5000,   0.15,  0.25 },
        { 5000,  6000,   0.25,  0.30 },   -- 终局：元素伤害打7折
    },
    -- 穿甲抵抗: 降低英雄穿甲有效率（0.30 = 英雄穿甲只生效70%）
    armorPenResist = {
        {    1,   500,   0.00,  0.00 },
        {  500,  2000,   0.00,  0.10 },
        { 2000,  4000,   0.10,  0.20 },
        { 4000,  6000,   0.20,  0.30 },   -- 终局：穿甲只生效70%
    },
}
...
Config.HP_SCALE_SEGMENTS = {
    ...
    {   800,  1000,        500,           1500 },
    {  1000,  1500,       1500,           5000 },
    {  1500,  2000,       5000,          20000 },
    {  2000,  2500,      20000,          60000 },
    {  2500,  3000,      60000,         180000 },
